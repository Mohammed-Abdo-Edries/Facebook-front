    ...
    <motion.div className="myform h-[calc(100vh-120px)] flex justify-center items-center"
      ...
      >
        ...
        <div className="formdiv h-12 mb-4 relative">
          <input type="email" placeholder=' ' className="forminput w-full h-full text-lg absolute p-4 bg-none rounded-lg  outline-none focus:border-blue-500 transition duration-200" 
